...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='exp_mask_freeze_batch32', help='model save at {SM_MODEL_DIR}/{name}')
    ...
    ################################# my args
    parser.add_argument('--mask_label', default='mask') # mask, normal, incorrect_mask
